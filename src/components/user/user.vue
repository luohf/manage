...
<el-card >
  ...
  <el-table :data="userlist" border stripe>
    ...
    <el-table-column label="操作" width="180px">
        <template slot-scope="scope">
          <!-- 修改 -->
        <el-button type="primary" @click ="showEditDialog(scope.row.id)" icon="el-icon-edit" size="mini" round></el-button>
        <!-- 删除 -->
...
<!-- 弹出框 -->
<el-dialog
  title="添加用户" :visible.sync="dialogVisible"
   ...
   data() {
    //    规则
       ...
       var checkMobile = (rule,value,cb) => {
           const Mobile =/^(0|86|17951)?(13[0-9]|15[0123456789]|17[678]|18[0-9]|14[57])[0-9]{8}$/
